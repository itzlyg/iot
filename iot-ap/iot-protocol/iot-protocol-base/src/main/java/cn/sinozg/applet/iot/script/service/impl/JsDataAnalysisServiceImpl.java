 ...
 */
@Slf4j
public class JsDataAnalysisServiceImpl implements DataAnalysisService {

    private final ScriptEngineService scriptEngine = ScriptFactory.scriptEngine(ScriptType.JS);
    @Override
