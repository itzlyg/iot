...
public class Constants {
    ...
    public static final class CallActivityParamType {
        public static final String NONE = "none";
        public static final String PART = "part";
        public static final String FULL = "full";
    }

    public static final class CallActivityExecuteType {
        public static final String SYNC = "sync";
        public static final String ASYNC = "async";
    }

    public static final class CallActivityInstanceType {
        public static final String SINGLE = "single";
        public static final String MULTIPLE = "multiple";
    }

    public static final class CallActivityDataTransferType {
